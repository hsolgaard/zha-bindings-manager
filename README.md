...
added in v0.9.0).
<img width="1406" height="426" alt="Screenshot 2026-07-11 at 23 47 41" src="https://github.com/user-attachments/assets/6e72f1c0-8c67-4dfc-b7da-f2cc70d13b17" />
...
<img width="701" height="354" alt="Screenshot 2026-07-11 at 23 49 23" src="https://github.com/user-attachments/assets/ce1cc129-00bf-460d-9659-db952288001c" />
...
network. Code assisted by [Claude](https://www.anthropic.com/claude) (Anthropic).

Built on top of:
- [ZHA](https://www.home-assistant.io/integrations/zha/) (Home Assistant core)
- [zha-toolkit](https://github.com/mdeweerd/zha-toolkit) by mdeweerd and contributors  another node to jump to the Advanced tab with both devices pre-selected as
  Source/Target and the most likely compatible cluster pre-picked, so you can
  choose the exact endpoint(s) before creating the bind. Click a line to
  inspect or remove it. Filter by device role (coordinator/routers/end devices/groups/
  unbound), by entity type (Light, Switch, Garage Door, Motion Sensor, etc —
